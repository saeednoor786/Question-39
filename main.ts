...
function country_city (city: string, country: string): string{
    return `${city}, ${country}`;
}

//  calling function with three citi_country pairs
let city1: string = country_city("lahore", "pakistan");
let city2: string = country_city("new york", "USA");
let city3: string = country_city("paris", "France");
